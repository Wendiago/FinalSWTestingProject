...
/** Users **/
INSERT INTO users (first_name, last_name, address, city, state, country, postcode, phone, dob,
                     email, password, role)
VALUES ('John', 'Doe', 'Test street 123', 'Utrecht', NULL, 'The Netherlands', NULL, NULL, '1980-01-01',
        'admin@practicesoftwaretesting.com', '$2y$10$pvW9Ixi7okDIJC98Vte6e.iAMD6IZAxAR2V.SjW.m1.u5guoq1wxW', 'admin'),
       ('Jane', 'Doe', 'Test street 98', 'Vienna', NULL, 'Austria', NULL, NULL, '1980-02-02',
        'customer@practicesoftwaretesting.com', '$2y$10$pvW9Ixi7okDIJC98Vte6e.iAMD6IZAxAR2V.SjW.m1.u5guoq1wxW', 'user'),
       ('Jack', 'Howe', 'Test street 654', 'Frankfurt', NULL, 'Germany', NULL, NULL, '1980-03-03',
...
VALUES (1, 2, '2019-04-05 22:04:47', 'INV-2019000001', 'Test street 123', 'Utrecht', 'Utrecht', 'The Netherlands', '1122AB', '34.04',
       ...
       (5, 2, '2021-10-30 22:04:47', 'INV-2021000002', 'Test street 123', 'Brussels', 'Brussels', 'Belgium', '1122AB', '27.11',
        'Cash on Delivery', 'Tester', '09876543ABC', NOW()),
       (6, 2, NOW() - INTERVAL '3 days', 'INV-2022000001', 'Test street 123', 'Utrecht', 'Utrecht', 'The Netherlands', '1122AB', '20.14',
        'Cash on Delivery', 'Tester', '09876543ABC', NOW()),
        ...
        'Cash on Delivery', 'Tester', '09876543ABC', NOW()),
        (9, 3, NOW() - INTERVAL '3 days', 'INV-2022000003', 'Midway Road 123', 'Springdale', 'Arkansas', 'United States', '72764', '20.14',
        'Cash on Delivery', 'Tester', '09876543ABC', NOW()),
